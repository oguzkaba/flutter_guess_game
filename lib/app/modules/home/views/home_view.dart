        ...
        body: Center(
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: TextFormField(
                          ...
                          onChanged: (name) =>
                              controller.playerName.value = name),
                    ),
                    vPaddingM,
                    Obx(() => Row(
              ...
              Expanded(flex: 5, child: _infoTable()),
              Expanded(
                flex: 2,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    hPaddingS,
                    _mainButton(
                        "assets/images/play_games.png",
                        "Başlat",
                        () => Get.toNamed(Routes.PLAYGAME),
                        greenColor,
                        23,
                        1.1),
                  ],
    ...
    return Card(
      child: Column(
        children: [
          ...
          SizedBox(width: Get.width * .9, child: Divider(color: logoLineColor)),
          ListTile(
